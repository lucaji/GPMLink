...
namespace GPMLib {
    ...
    public class DataSample {
        ...
        public static DataSample? Factory(string[] parts) {
            ...
            var u = Formatters.StringExponential2Double(parts[0], out bool success);


            if (!success) { GPMDevice.LogToConsole("cannot parse U"); goto bail; }
            var i = Formatters.StringExponential2Double(parts[1], out success);
            if (!success) { GPMDevice.LogToConsole("cannot parse I"); goto bail; }
            var p = Formatters.StringExponential2Double(parts[2], out success);
            ...
            r.Wh = Math.Abs(Formatters.StringExponential2Double(parts[4], out success));
            r.Ah = Math.Abs(Formatters.StringExponential2Double(parts[5], out success));
            return r;
        bail:
            return null;
        }
        ...
        public double TimeX {
            get {
                return this.TimeStamp.ToOADate();
            }
        }
        ...
        public double IntegratorExcelTime => this.IntegratorTime / 86400.0;
        ...
        public string WhFormattedValue {
            get {
                wh_unit = "Wh";
                return Formatters.FormatDoubleWithUnit(Wh, ref wh_unit, keepUnit: false);
            }
        }
        public string mWhFormattedValue {
            get {
                wh_unit = "mWh";
                return Formatters.FormatDoubleWithUnit(mWh, ref wh_unit, keepUnit: false);
            }
        }
        public string WhUnit {
            get {
                wh_unit = "Wh";
                _ = Formatters.FormatDoubleWithUnit(Wh, ref wh_unit);
                return wh_unit;
            }
        }
        public string mWhUnit {
            get {
                wh_unit = "mWh";
                _ = Formatters.FormatDoubleWithUnit(mWh, ref wh_unit);
                return wh_unit;
            }
        }
        ...
        public string WhFormattedStringWithUnit {
            get {
                wh_unit = "Wh";
                return Formatters.FormatDoubleWithUnit(Wh, ref wh_unit);
            }
        }
        public string mWhFormattedStringWithUnit {
            get {
                wh_unit = "mWh";
                return Formatters.FormatDoubleWithUnit(mWh, ref wh_unit);
            }
        }
        ...
        public string AhFormattedValue {
            get {
                ah_unit = "Ah";
                return Formatters.FormatDoubleWithUnit(Ah, ref ah_unit, keepUnit: false);
            }
        }
        ...
        public string mAhFormattedValue {
            get {
                ah_unit = "mAh";
                return Formatters.FormatDoubleWithUnit(mAh, ref ah_unit, keepUnit: false);
            }
        }
        public string AhUnit {
            get {
                ah_unit = "Ah";
                _ = Formatters.FormatDoubleWithUnit(Ah, ref ah_unit);
                return ah_unit;
            }
        }
        public string mAhUnit {
            get {
                ah_unit = "mAh";
                _ = Formatters.FormatDoubleWithUnit(mAh, ref ah_unit);
                return ah_unit;
            }
        }
        public string mAhFormattedStringWithUnit {
            get {
                ah_unit = "mAh";
                return Formatters.FormatDoubleWithUnit(Ah, ref ah_unit);
            }
        }
        ...
        public double VoltageValue {
            get {
                u_unit = "V";
                return Formatters.FormatDoubleExpand(Voltage, ref u_unit);
            }
        }
        public string VoltageFormattedValue {
            get {
                u_unit = "V";
                return Formatters.FormatDoubleWithUnit(Voltage, ref u_unit, keepUnit: false);
            }
        }
        public string VoltageFormattedWithUnit {
            get {
                u_unit = "V";
                return Formatters.FormatDoubleWithUnit(Voltage, ref u_unit);
            }
        }
        public string VoltageUnit {
            get {
                u_unit = "V";
                _ = Formatters.FormatDoubleWithUnit(Voltage, ref u_unit);
                return u_unit;
            }
        }
        ...
        public double CurrentValue {
            get {
                i_unit = "A";
                return Formatters.FormatDoubleExpand(Current, ref u_unit);
            }
        }
        public string CurrentFormattedValue {
            get {
                i_unit = "A";
                return Formatters.FormatDoubleWithUnit(Current, ref i_unit, keepUnit: false);
            }
        }
        ...
        public string CurrentFormattedWithUnit {
            get {
                i_unit = "A";
                return Formatters.FormatDoubleWithUnit(Current, ref i_unit);
            }
        }
        public string CurrentUnit {
            get {
                i_unit = "A";
                _ = Formatters.FormatDoubleWithUnit(Current, ref i_unit);
                return i_unit;
            }
        }
        ...
        public double PowerValue {
            get {
                p_unit = "VA";
                return Formatters.FormatDoubleExpand(Power, ref u_unit);
            }
        }
        public string PowerFormattedValue {
            get {
                p_unit = "VA";
                return Formatters.FormatDoubleWithUnit(Power, ref p_unit, keepUnit: false);
            }
        }
        ...
        public string PowerFormattedWithUnit {
            get {
                p_unit = "W";
                return Formatters.FormatDoubleWithUnit(Power, ref p_unit);
            }
        }
        public string PowerUnit {
            get {
                p_unit = "W";
                _ = Formatters.FormatDoubleWithUnit(Power, ref p_unit);
                return p_unit;
            }
        }
