...
namespace GPMLib.Netcore {
    ...
    public class INTEGrator : BaseCommand {
        ...
        public event EventHandler<INTEGrator> HasChangedEvent;
        ...
        public INTEGrator(GPMDevice pd) : base(pd) { }
        ...
        public void ParseStatusResponse(string r) {
            if (string.IsNullOrWhiteSpace(r)) { return; }
            var result = GPMIntegratorStatusEnum.Unknown;
            var e = IntegratorStatuses.FirstOrDefault(s => s.Item3.Equals(r));
            if (e != default) {
                result = e.Item1;
                if (result != this.IntegratorStatus) {
                    IntegratorStatus = result;
                    this.HasChangedEvent?.Invoke(this.ParentDevice, this);
                }
            }
        }
        ...
        public static GPMIntegratorModeEnum ParseModusResponse(string r) {
        ...
        GPMIntegratorModeEnum _IntegratorMode = GPMIntegratorModeEnum.Unknown;

        public GPMIntegratorModeEnum IntegratorMode => _IntegratorMode; 
        ...
        public async Task<bool> GetIntegratorMode() {
            ...
            _IntegratorMode = ParseModusResponse(s);
            return _IntegratorMode != GPMIntegratorModeEnum.Unknown;
        }
        ...
        public static GPMIntegratorFunctionEnum ParseIntfunctionResponse(string r) {
            if (string.IsNullOrWhiteSpace(r)) { goto bail; }
